...
public class Uzd1 {
	...
	public static void main(String[] args) {
		...
		case "Noteikt vārda garumu":
			if(!mansSteks.isEmpty())
				JOptionPane.showMessageDialog(null,
						"Stekā esošā vārda garums: "+mansSteks.size(),
						"Paziņojuma", JOptionPane.INFORMATION_MESSAGE);
		...
		case "Apskatīt pēdējo burtu":
			if(!mansSteks.isEmpty())
				JOptionPane.showMessageDialog(null,
						"Stekā esošā vārda pēdējais burts: "+mansSteks.peek(),
						"Paziņojums", JOptionPane.INFORMATION_MESSAGE);
	...
	if(!mansSteks.isEmpty()) {
		...
		JOptionPane.showMessageDialog(null,
				"Apgrieztais vārds: "+vards, "Paziņojums",
